    ...
    public class RepositoryEnfermos
    {
        ...
        public Enfermo BuscarEnfermo(int inscripcion) {
            var consulta = from datos in this.context.Enfermos
                           ...
                           select datos;
            //CUANTOS DATOS DEVOLVERA LA CONSULTA???? 1 o ninguno
            //DEBERIAMOS PREGUNTAR SI TENEMOS DATOS O NO
            //UTILIZAMOS EL METODO Count() DE Linq PARA PREGUNTAR
            ...
            else
            {
                ...
                //UNA CONSULTA NUNCA SABRA SI TIENE UNO O VARIOS ELEMENTOS
                //MEDIANTE EL METODO .First() DEVOLVEMOS EL PRIMERO
